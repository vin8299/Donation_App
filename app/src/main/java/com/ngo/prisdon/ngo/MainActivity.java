...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_about) {
            ...
            Intent intent = new Intent(this, DonateNow.class);
            startActivity(intent);
        } else if (id == R.id.nav_join) {
            Intent intent = new Intent(this, JoinNow.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(this, PressRelease.class);
            startActivity(intent);
    ...
    public void DonateNowClicked(View view){
        Intent intent = new Intent(this, DonateNow.class);
        startActivity(intent);
    }
    ...
    public void AskForHelpClicked(View view) {
        Intent intent = new Intent(this, AskForHelp.class);
        startActivity(intent);
    }
    public void PressReleaseClicked(View view) {
        Intent intent = new Intent(this, PressRelease.class);
        startActivity(intent);}
